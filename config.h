...
#define CMDLINE_PARSER_PACKAGE "palz"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "palz"
#endif
...
struct gengetopt_args_info
{
  ...
  unsigned int decompress_given ;	/**< @brief Whether decompress was given.  */
  unsigned int folder_decompress_given ;	/**< @brief Whether folder-decompress was given.  */
