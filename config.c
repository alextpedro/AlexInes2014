...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->decompress_arg = NULL;
  args_info->decompress_orig = NULL;
  args_info->folder_decompress_arg = NULL;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->decompress_given)
    write_into_file(outfile, "decompress", args_info->decompress_orig, 0);
  if (args_info->folder_decompress_given)
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "decompress") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->decompress_arg), 
                ...
                &(local_args_info.decompress_given), optarg, 0, 0, ARG_STRING,
          ...
          else if (strcmp (long_options[option_index].name, "folder-decompress") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->folder_decompress_arg), 
                ...
                &(local_args_info.folder_decompress_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "folder-decompress", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "compress") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->compress_arg), 
                ...
                &(local_args_info.compress_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "compress", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "parallel-folder-compress") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->parallel_folder_compress_arg), 
                 &(args_info->parallel_folder_compress_orig), &(args_info->parallel_folder_compress_given),
                &(local_args_info.parallel_folder_compress_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "parallel-folder-compress", '-',
                additional_error))
              goto failure;
